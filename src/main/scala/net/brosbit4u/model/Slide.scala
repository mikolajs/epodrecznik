...
case class Slide(var _id: ObjectId,  var confirmed:Boolean, var delReq:Boolean, var authors: List[Edit], 
				var title: String, var departmentInfo: String, var departmentId:ObjectId, var referTo:ObjectId,
				var moderator: String, var subjectInfo: String, var subjectLev:Int, var subjectId:ObjectId, var slides: ObjectId) 
